...
function busq(place) {
	// slider_wraper.removeChild(target)
	// target.remove()
	const promesa = fetch(pop_url+api+query+lang)
  	.then(response => response.json())
		.then((data) => {
			...
			// var your_class = document.createElement('div')
			// your_class.setAttribute("class", "your-class container" )
			// slider_wraper.appendChild(your_class)
...
pop_btn.addEventListener('click', () => busq(puntero))
genre_btn.map((e) => {
